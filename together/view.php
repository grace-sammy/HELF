  ...
  <div id="ripple2">
    ...
    <form name="ripple_form" action="dml_board.php?mode=insert_ripple" method="post">
      ...
      <div id="ripple_insert">
        <div id="ripple_textarea"><img src="../community/pic/ripple.png" alt=""><textarea name="ripple_content" rows="3" cols="86"></textarea><input type="submit" value="&nbsp&nbsp입력&nbsp&nbsp"></div>
