  ...
  <body>
    ...
    <section>
        <div id="admin_border">
         ...
         <div id="content">
           <h1 id="content_title">게시글 관리 > 후기게시판</h1><br>
           <form id="delete_board_form" action="admin_board_review.php?page=<?=$page?>" method="post">
             <div id="all_check">
              ...
              for ($i=$start; $i<$start+$scale && $i < $total_record; $i++) {
                  ...
                  ?>
                   <li id="board_content">
                     ...
                     <span class="col2"><a href="../community/review/view.php?num=<?=$num?>&page=<?=$page?>&hit=<?=$hit+1?>"><?=str_cutting($subject,90)?></a></span>
           ...
           <?php
               if ($total_page>=2 && $page >= 2) {
                   $new_page = $page-1;
                   echo "<li><a href='admin_board_review.php?page=$new_page'>◀ 이전</a> </li>";
               } else {
                   echo "<li>&nbsp;</li>";
               }
               ...
               for ($i=1; $i<=$total_page; $i++) {
                   if ($page == $i) {     // 현재 페이지 번호 링크 안함
                       ...
                       echo "<li><a href='admin_board_review.php?page=$i'>  $i  </a><li>";
                   }
               }
               if ($total_page>=2 && $page != $total_page) {
                   $new_page = $page+1;

                   echo "<li> <a href='admin_board_review.php?page=$new_page'>다음 ▶</a> </li>";
               } else {
                   echo "<li>&nbsp;</li>";
               }
           ?>
